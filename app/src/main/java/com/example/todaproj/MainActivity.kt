...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val passwordToggleLayout = findViewById<TextInputLayout>(R.id.password_input_layout)
        val loginButton = findViewById<Button>(R.id.login_btn)
        val registerButton = findViewById<Button>(R.id.register_btn)

        passwordToggleLayout.setOnClickListener {
            ...
            loginButton.setOnClickListener {
                ...
                ApiClient.getInstance(applicationContext).createApiService()
                        ...
                        override fun onResponse(
                            ...
                            if (response.isSuccessful && response.body() != null) {
                                ...
                                if (user != null) {
                                    ...
                                    Toast.makeText(applicationContext, "User data is null", Toast.LENGTH_SHORT).show()
                                }
